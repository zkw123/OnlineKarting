...
namespace KartGame.KartSystems
{
    ...
    /// </summary>
    [RequireComponent (typeof(Collider))] public class WallCollider : MonoBehaviour
    {
        ...
        public Vector3 ModifyVelocity (KartPlayer collidingKart, RaycastHit collisionHit)
        {
